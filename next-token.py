...
def pullData(symbol, queryClient, nextToken):
	try:
		...
		# nextToken = 'AYABeIep7vyNzqXQr0Z9ECoIUBcAAAABAAdhd3Mta21zAEthcm46YXdzOmttczp1cy1lYXN0LTI6MjU0MzMyNjcyNDM5OmtleS84Mzg0ZTM3YS00Y2Y2LTQ4ODQtYTE2Yy03OWRjNWZkMGIwMDQAuAECAQB4c12CXZ9y_S9nEPb2Z1LBQzHgklgmHgDEUjaoICFSLqYBfajr_7wAEZk_Ja36ertX9QAAAH4wfAYJKoZIhvcNAQcGoG8wbQIBADBoBgkqhkiG9w0BBwEwHgYJYIZIAWUDBAEuMBEEDMwNomhc2H02aHfpKwIBEIA7NPHiKxth5hH7ybFXcQy9JyxMmdIWnPz3e6rXlUn_rD827X5D7H3s3zyZSKCXAb-FVD1zpMFX5_3bvsECAAAAAAwAABAAAAAAAAAAAAAAAAAAp6U2sIDWQIBtAcp5DDMbzf____8AAAABAAAAAAAAAAAAAAABAAABG8bQf8xzfSwZeaZDdeDnQGoAmxwOaMLOFuGFBakusYzglJ3rhVQama2ZKvjxqJo5A-d7fQCC2eGVnlnOgS8B8fnw6zQ_75Nwm5xY63O4_SCkD0GKX8eBpPWp2sY3eiWKQv8u0eNV3B1liTspRS9P4trXa2yv1HQ1XRGw626kRZN6Fg3PbWFqPEG4fB1fTX6ZJpoteRlG6vadRzbswS3VeYp97k7JyTfwu42kh3m3UYX8DYiKiwRrHxpSW5dfN-ehH1CIRCuMWy9tRoAvEhfW1uqFoLMdYuquHo2aSWyy9K8Qq05Vh0S-YPwQh5DkdIPaO964RZHiAH4G6PCK5TLya6u0aSwC4TcNCLremB_DCCrUseEO5kLhBAIJ5aV1HWMzbgNTLg4vMKBXtrSf'
		print("Querying %s with query %s and nextToken %s at %s" % (symbol, queryString, nextToken, str(datetime.datetime.now())))
...
def saveToFile(symbol):
	...
	with open('BTC-USD_2024-07-18-23.00.00.000000000_2024-07-22-02.00.00.000000000', 'a') as file:
		nextToken = 'AYABeK5zP82LHJo2EWBJtTybjqMAAAABAAdhd3Mta21zAEthcm46YXdzOmttczp1cy1lYXN0LTI6MjU0MzMyNjcyNDM5OmtleS84Mzg0ZTM3YS00Y2Y2LTQ4ODQtYTE2Yy03OWRjNWZkMGIwMDQAuAECAQB4c12CXZ9y_S9nEPb2Z1LBQzHgklgmHgDEUjaoICFSLqYB020TpKIL89RyDhzXsu2BLAAAAH4wfAYJKoZIhvcNAQcGoG8wbQIBADBoBgkqhkiG9w0BBwEwHgYJYIZIAWUDBAEuMBEEDKTmLnKKMofw_WpTWQIBEIA7Uhtdogo1z0DWDttHNIWCsZepOhAWNZwqiTKMJiOV2D-PAX6ey1RN-xc5fRRaJUcVnClj7aO9jKKnSmkCAAAAAAwAABAAAAAAAAAAAAAAAAAAHoO6XePFy8zzFmH9BO4vsf____8AAAABAAAAAAAAAAAAAAABAAABHJCLQC3DDkDUt7B5y_uXxEqWlhFC1G2VxXFncunBBIAmZcKKwnAIcdAfW8EwwmMrCIOgwX7W39Xi-AldKYCxVJBJtZ64ekvvqMEtiPCDyJh8yOKyQxE18Wulfyx_S_N8JDJOOdQTxyvue5m5gJGXYkodzS2rPARdYN6voVfWnzkwdNtLoJ0PjoLlzVCJDs5BeLYTgKKOe3fZKH3fV4VCqpPsXlMq5MzXT0JheDjC6bk4sLPtj_CG4mnk9-TqvCNZ8hjhON3gmrirK4gJ2jx03yVjaox7m5AX3OxKxvj6dBjv6Gx9dg_0LnOIBQdbneLTNwzSGeCPpryrAKXNDjvudlGx53c157dgMtT63uJl0T1YmeSbUZ9Uhcj0HTuu4W_4-ZjfBuTU_jorqcnJPA'
		response = pullData(symbol, queryClient, nextToken)
		while response:
